...
var obtainedMarks1 = +prompt(Enter your ${userSubjectInput1} obtained marks);
...
<tr>
<td>${userSubjectInput1} </td><td> ${totalNumber} </td><td> ${obtainedMarks1} </td><td> ${obtainedMarks1 / totalNumber * 100 }%</td>
</tr>
<tr>
<td>${userSubjectInput2} </td><td> ${totalNumber} </td><td> ${obtainedMarks2} </td><td> ${obtainedMarks2 / totalNumber * 100 }%</td>
</tr>
<tr>
<td>${userSubjectInput3} </td><td> ${totalNumber} </td><td> ${obtainedMarks3} </td><td> ${obtainedMarks3 / totalNumber * 100 }%</td>
</tr>
<tr>
<td></td><th> ${totalNumber * 3} </th><th> ${obtainedMarks3 + obtainedMarks1 + obtainedMarks2} </th><th> ${(obtainedMarks1 + obtainedMarks2 + obtainedMarks3 / 300 )* 100}%</th>
</tr>
</table>`);